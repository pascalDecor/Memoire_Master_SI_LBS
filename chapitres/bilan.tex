...
La limite principale n'est plus le volume observé. Le fonds de production (35\,007 documents) et l'échantillon de test ($n = 205$) suffisent à décrire la robustesse du pipeline et la recherche. La limite est celle de la \textbf{référence}. Tant que le gold recopie les sorties de production, aucun score d'OCR, de classification ou d'extraction ne démontre une qualité métier. Le harnais retrouverait ce que le système a déjà écrit.
