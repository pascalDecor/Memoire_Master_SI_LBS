...
\usepackage{graphicx}
% Aide à l'inclusion des PNG quel que soit le moteur (évite l'erreur BoundingBox).
...
Au \nomMinistere{}, le traitement des archives repose encore largement sur une chaîne d'opérations manuelles. Environ cinq secrétaires y participent, pour un volume moyen estimé à 3\,000 dossiers par an. Les documents papier sont numérisés, déposés sur un serveur Windows selon une arborescence prédéfinie, puis référencés dans un fichier Excel. Cette organisation assure une conservation et une recherche de base ; elle devient cependant plus difficile à tenir lorsque le volume augmente et que les pièces restent hétérogènes.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,bb=0 0 1024 559]{images/ancienne_architecture_dossier.png}
...
Dans la pratique, le traitement d'une pièce physique enchaîne ainsi plusieurs opérations : numérisation, récupération du fichier, identification de l'expéditeur et du type, détermination de l'année et du mois, création ou sélection du répertoire, nommage, déplacement, puis saisie des champs Excel. Avec cinq secrétaires et environ 3\,000 dossiers par an, ces gestes répétitifs constituent une charge structurelle. L'ensemble de ce processus est représenté à la figure~\ref{fig:processus-documentaire-existant}.
...
Gouvernance & Valider, sécuriser et tracer les opérations \\
